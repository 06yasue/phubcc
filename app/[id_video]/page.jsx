...
import siteConfig from '@/config'; // Panggil nama situs dari config
...
export default async function FakeVideoPage({ params }) {
  ...
  // 1. CARI DATA VIDEO INI (LOGIKA ASLI LO)
  ...
  // 2. AMBIL 20 VIDEO ACAK UNTUK "POPULER" (LOGIKA ASLI LO)
  ...
  // 3. SERVER ACTION: FUNGSI TOMBOL PLAY (LOGIKA ASLI LO)
      ...
      <div className="container" style={{ marginTop: '25px', maxWidth: '1000px' }}>
        <div className="row">
          ...
          <div className="col-md-8">
            ...
            {/* FAKE VIDEO PLAYER (Dengan animasi loading via Vanilla JS) */}
            <form id="playForm" action={grantAccess} style={{ marginBottom: '20px' }}>
              <button id="playBtn" type="submit" style={{ width: '100%', border: 'none', padding: 0, background: 'transparent', cursor: 'pointer', position: 'relative' }}>
