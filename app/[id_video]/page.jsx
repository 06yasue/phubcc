...
export default async function FakeVideoPage({ params }) {
  ...
  async function grantAccess() {
    ...
    redirect(`/tube_${id_video}/${slugTitle}`);
     ...
     return (
    <div style={{ backgroundColor: '#ffffff', minHeight: '100vh', paddingTop: '30px', paddingBottom: '60px' }}>
      <div className="container" style={{ maxWidth: '900px' }}>
        ...
        <div style={{ marginBottom: '25px', border: '1px dashed #cbd5e1', background: '#f8fafc', borderRadius: '4px', textAlign: 'center', padding: '15px' }}>
